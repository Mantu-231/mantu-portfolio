const skillGroups = [
  {
    ...
    skills: ["Python", "Java", "SQL", "TypeScript", "JavaScript", "C"],
  },
  {
    number: "02",
    title: "Backend & APIs",
  ...
  },
  {
    ...
    skills: ["React.js", "Next.js", "Tailwind CSS", "HTML", "CSS", "Streamlit"],
  },
  {
    number: "04",
    title: "Data, AI & Machine Learning",
    description: "Working with data, analytics, machine learning, and intelligent systems",
    skills: ["PostgreSQL", "MySQL", "SQLite", "Pandas", "scikit-learn", "Data Analysis", "Machine Learning", "AI/ML", "Agentic AI"],
  },
  {
    number: "05",
